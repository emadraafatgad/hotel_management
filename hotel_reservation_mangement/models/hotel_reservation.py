...
class HotelReservation(models.Model):
    ...
    reserved_room_quantity = fields.Integer(compute='get_total_price_and_reserved_rooms',store=True,string="Room Counter",readonly=True)
    note = fields.Text()
    ...
    def get_total_price_and_reserved_rooms(self):
        for rec in self:
            ...
            rec.update({'total_price': total_price,'room_nights': room_nights,'reserved_room_quantity': reserved_rooms,'adults':total_adults})
